...
```{r}
ggsave(here("figures/Num_species_within_num_farms.png"), width = 4, height = 2)
```
...
```{r}
ggsave(here("figures/Num_species_per_farm_by_habitat.png"), width = 4, height = 2)
```
```{r}
table(wind_sp_only2$Industry)
```
...
```
```{r}
ggsave(here("figures/Num_species_per_industry_by_habitat.png"), width = 4, height = 2)
```
